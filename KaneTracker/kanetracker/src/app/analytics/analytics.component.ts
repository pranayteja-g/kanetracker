        ...
        <mat-card class="chart-card">
          <mat-card-header>
            <mat-card-title>
              ...
              <button mat-icon-button 
                      ...
                      (click)="toggleChart('categoryChart')"
                      [attr.aria-label]="chartVisibility.categoryChart ? 'Hide chart' : 'Show chart'">
                <mat-icon class="toggle-icon" [class.rotated]="chartVisibility.categoryChart">
          ...
          <mat-card-content *ngIf="!chartVisibility.categoryChart" class="chart-preview">
            <div class="preview-content">
              ...
              <p>Click the expand button to view category breakdown chart</p>
        ...
        <mat-card class="chart-card">
          <mat-card-header>
            <mat-card-title>
              ...
              <button mat-icon-button 
                      class="toggle-chart-btn" 
                      (click)="toggleChart('monthlyTrends')"
                      [attr.aria-label]="chartVisibility.monthlyTrends ? 'Hide chart' : 'Show chart'">
                <mat-icon class="toggle-icon" [class.rotated]="chartVisibility.monthlyTrends">
          ...
          <mat-card-content *ngIf="!chartVisibility.monthlyTrends" class="chart-preview">
            <div class="preview-content">
              <mat-icon>visibility</mat-icon>
              <p>Click the expand button to view monthly trends chart</p>
        ...
        <mat-card class="chart-card full-width">
          <mat-card-header>
            <mat-card-title>
              ...
              <button mat-icon-button 
                      class="toggle-chart-btn" 
                      (click)="toggleChart('incomeVsExpenses')"
                      [attr.aria-label]="chartVisibility.incomeVsExpenses ? 'Hide chart' : 'Show chart'">
                <mat-icon class="toggle-icon" [class.rotated]="chartVisibility.incomeVsExpenses">
          ...
          <mat-card-content *ngIf="!chartVisibility.incomeVsExpenses" class="chart-preview">
            <div class="preview-content">
              <mat-icon>visibility</mat-icon>
              <p>Click the expand button to view income vs expenses comparison</p>
        ...
        <mat-card class="chart-card">
          <mat-card-header>
            <mat-card-title>
              ...
              <button mat-icon-button 
                      class="toggle-chart-btn" 
                      (click)="toggleChart('topCategories')"
                      [attr.aria-label]="chartVisibility.topCategories ? 'Hide chart' : 'Show chart'">
                <mat-icon class="toggle-icon" [class.rotated]="chartVisibility.topCategories">
          ...
          <mat-card-content *ngIf="!chartVisibility.topCategories" class="chart-preview">
            <div class="preview-content">
              <mat-icon>visibility</mat-icon>
              <p>Click the expand button to view top spending categories</p>
